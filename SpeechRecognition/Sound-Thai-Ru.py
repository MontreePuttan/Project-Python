...
def translate_and_convert_to_mp3(text, dest_language='ru'):
    # Translate the text to Russian
    translated = translator.translate(text, dest=dest_language)
    print(f"Original (Thai): {text}")
    print(f"Translated (Russian): {translated.text}")
...
# Main function to recognize Thai speech and translate to Russian
def main():
    print("== เริ่มการทำงาน ==")
    with sr.Microphone() as source:
        ...
        try:
            ...
            # Translate the recognized text from Thai to Russian and convert to MP3
            translate_and_convert_to_mp3(text, dest_language='ru')
